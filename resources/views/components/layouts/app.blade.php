...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('front/icomoon/icomoon.css')}}">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="right-element">
							<a href="/admin/login" class="user-account for-buy"><i
		...
		<header id="header">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-2">
						<div class="main-logo">
							<a href="index.html"><p style="font-size: 2rem;font-weight: bold;color: black">KH <i style="background: rgb(212, 157, 53);font-size: 1rem;padding: 0.5rem;color: white">READING</i></p></a>
						</div>
...
<main>
 {{ $slot }}
			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-5">
							<figure>
								<img src="{{asset('front/images/device.png')}}" alt="phone" class="single-image">
							</figure>
						</div>
				...
				<div class="col-md-4">
					...
					<div class="footer-item">
						<div class="company-brand">
							<p style="font-size: 2rem;font-weight: bold;color: black">KH <i style="background: rgb(212, 157, 53);font-size: 1rem;padding: 0.5rem;color: white">READING</i></p>
				...
				<div class="col-md-12">
					...
					<div class="copyright">
						<div class="row">
							...
							<div class="col-md-6">
								<p>© 2025 All rights reserved.Devluy</p>
							</div>
	...
	<script src="{{asset('front/https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js')}}"
